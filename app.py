...
def css():
    ...
    .stApp {
      background: radial-gradient(circle at 18% 5%, #152f2b, transparent 28%),
                  radial-gradient(circle at 82% 15%, #24152f, transparent 30%),
                  #090d14;
      color: #f5f7fb;
    ...
    .hero {
      background: linear-gradient(135deg, rgba(19,32,52,.96), rgba(18,42,39,.96));
    ...
    .hero h1 { color: #3a87ff !important; }
    .subtitle { color: #aebed0; }
    ...
    div[data-testid="stMetricLabel"] { color: #a4b2c4 !important; }
    div[data-testid="stMetricValue"] { color: #eef6ff !important; }
    ...
    .active {
      border-color: #397af0;
      background: linear-gradient(90deg, #182d52, #18243b);
      box-shadow: 0 0 0 1px rgba(57,122,240,.25);
    }

    .route b { color: #63a4ff; }
    .route span { color: #b7c5d6; }

    .ai {
      background: linear-gradient(135deg, #18243a, #211837);
    ...
    .call {
      display: block;
      background: linear-gradient(135deg, #276cf3, #7140dd);
      color: #fff !important;
    ...
    [data-testid="stChatMessage"] * { color: #edf4ff !important; }
